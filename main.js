...
`};var b=a=>`RD$ ${Number(a||0).toFixed(2)}`,Q=(a,e)=>{let s=(a.installments||[]).reduce((d,h)=>d+Number(h.amount||0),0),t=e?.annualRate||null,i=t?Number(((a.amount||0)*(t/12)).toFixed(2)):0,n=Number((s+i).toFixed(2));return{installmentTotal:s,rate:t,estimatedFee:i,total:n}},la=(a=[],e)=>{if(!a.length)return`
      <div class="card highlight">
...
`,J=(a={})=>{let e=a.bnplOrders||[],s=a.merchants||[],t=a.aiRate;return`
    ...
    <section class="grid two">
      ...
      <div class="card">
        ...
        ${e.length?e.map(n=>{let d=Q(n,t),h=n.metadata?.source==="qr";return`
            <div class="goal">
              <div class="goal-head">
...
`;var _=(a={})=>{let s=(a.kids||{accounts:[]}).accounts||[];return`
  ...
  <section class="landing-hero premium-full fade-in">
    <div class="hero-row">
      <div class="hero-left">
        <img src="/assets/logo-neon.png" alt="CmLayerBank" class="hero-logo" />
      </div>
